...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-800 text-white py-8 px-4 sm:px-6 lg:px-12 mt-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        >
          ...
          <p className="text-sm text-gray-400 mt-1">© 2025 MovieFlex. All rights reserved.</p>
        </motion.div>
        ...
        <div className="flex space-x-6">
          <motion.a
            ...
            className="p-2 bg-yellow-500 rounded-full hover:bg-yellow-600 transition duration-300"
          >
            <svg
